...
\item The cause of your confusion was that expanding the metric around some point (which you can flatten using gaussian normal coordinates at any point one at a time) is not the same as taking limit of the metric near some region. Taking this limit, we may not get flat metric all the time, it was a mere coincidence in case of Near Horizon geometry of Schwarzschild Blackhole. Remember AdS2 geometry in RN blackhole?

\item All we can do in reality is measure proper distance, and use it to determine the coordinates that we use.
