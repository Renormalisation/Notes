...
\begin{itemize}
  ...
  \item Two fundamental postulates on inner prdocut in QM :
    $$\bra{\alpha}\ket{\alpha} = \bra{\beta}\ket{\alpha}^* \quad \textrm{and} \quad \bra{\alpha}\ket{\alpha} \ge 0$$ 
