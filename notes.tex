...
Tranlsations in different directions commute, therefore $[p_i,p_j] = 0$. Rotation in different directions don't commute, so we have a different algebra for their generators. This algebra defines everything.
