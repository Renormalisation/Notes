...
\begin{itemize}
  \item We cannot directly substitute the constants of motion into the lagrangian and then use euler lagrange equations for other coordinates. Because, the euler-lagrange equations were derived based on the assumption that the coordinates $q_i$ are independent. (David Tong Ch2, p.29)
